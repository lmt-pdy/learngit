<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="4">
          <el-input placeholder="请输入管理员名称" v-model="queryInfo.query" clearable @clear="getUserList">
    ...
    <!--修改用户的对话框-->
    <el-dialog title="修改管理员" :visible.sync="editDialogVisible" width="30%"  @close="editDialogClosed">
    ...
    <!--分配角色的对话框-->
    <el-dialog title="分配角色" :visible.sync="setRolesDialogVisible" width="30%"  @close="setRolesDialogClosed">
      <div>
